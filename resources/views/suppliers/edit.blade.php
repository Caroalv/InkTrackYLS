<x-app-layout>
    <div class="py-8 bg-slate-950 min-h-screen text-slate-100">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div>
                <h2 class="text-2xl font-bold text-white tracking-tight">Editar Proveedor</h2>
                <p class="text-xs text-slate-400 mt-1">Modificando los datos de: {{ $supplier->suppliername }}</p>
            </div>
            ...
            <div class="bg-slate-900 p-8 rounded-2xl border border-slate-800 shadow-2xl">
                <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="suppliername" value="{{ old('suppliername', $supplier->suppliername) }}" required 
