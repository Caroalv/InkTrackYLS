    ...
    <div x-data="{
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-1">
                        Gestión y directorio de proveedores de insumos
                    </p>
                </div>
                ...
                <button
                    ...
                    <svg class="w-4 h-4 me-2 group-hover:rotate-90 transition duration-200"
                         fill="none"
                         stroke="currentColor"
                         viewBox="0 0 24 24">
            ...
            <div class="bg-slate-900 p-4 rounded-2xl border border-slate-800 shadow-xl">
                ...
                <form method="GET"
                    ...
                    <button
                        type="submit"
                        class="px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold text-xs rounded-xl transition">
                    ...
                    @if(!empty($search))
                        ...
                        <a href="{{ route('suppliers.index') }}"
                           class="px-4 py-2.5 bg-slate-800/50 hover:bg-slate-800 text-slate-400 font-semibold text-xs rounded-xl transition flex items-center">
                            ...
                            @forelse($suppliers as $supplier)
                                ...
                                <tr class="hover:bg-slate-800/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-right space-x-2">
                                        ...
                                        <button
                                            @click='openEditModal(@json($supplier))'
        ...
        <div
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
                ...
                <div
                    x-show="showCreateModal"
                    class="inline-block align-bottom bg-slate-900 rounded-2xl text-left overflow-hidden shadow-2xl transform my-8 sm:align-middle sm:max-w-md sm:w-full border border-slate-800">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex justify-between items-center mb-4 pb-3 border-b border-slate-800">
                            ...
                            <button
                                @click="showCreateModal = false"
                                class="text-slate-400 hover:text-slate-200 text-lg font-bold leading-none">
                        ...
                        <form
                            ...
                            <div>
                                ...
                                <label class="block text-slate-300 font-medium text-xs mb-1">
                            ...
                            <div class="flex items-center justify-end space-x-2 pt-4 border-t border-slate-800 mt-5">
                                ...
                                <button
                                    type="submit"
                                    class="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-xs font-semibold transition shadow-md shadow-indigo-600/30">
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <form
                            :action="'/suppliers/' + editSupplier.id"
                            method="POST"
                            class="space-y-3">
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    name="suppliername"
                                    x-model="editSupplier.suppliername"
                                    required
                                    class="w-full bg-slate-950 border border-slate-700 text-white rounded-xl px-3 py-2 text-xs focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    name="contactname"
                                    x-model="editSupplier.contactname"
                                    class="w-full bg-slate-950 border border-slate-700 text-white rounded-xl px-3 py-2 text-xs focus:border-indigo-500 focus:ring-indigo-500">
